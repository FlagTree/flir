...
class StructuredToMemrefFlagTreePass
    : public triton::impl::StructuredToMemrefFlagTreeBase<
          StructuredToMemrefFlagTreePass> {
  using StructuredToMemrefFlagTreeBase<
      StructuredToMemrefFlagTreePass>::StructuredToMemrefFlagTreeBase;
...
public:
  ...
  void runOnOperation() override {
    ...
    module.walk([&](mlir::func::FuncOp funcOp) {
      ...
      {
        PtrToUnrankedMemrefConverter typeConverter;
        triton::populateStructuredToMemrefFlagTreeConversionPatterns(
